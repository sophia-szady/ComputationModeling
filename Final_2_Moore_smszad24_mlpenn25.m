% Final Project 2: using Moore neighborhoods and 2 set spores
...
% This simulation will have two spores placed near the middle of the field
% in order to demonstrate the figure 8 pattern seen in figure 14.5.2 in the
% textbook. We use a Moore neighborhood and absorbing boundary conditions 
...
% initializing 2 equally spaced spores in the field
initSporeX1 = cast(r/2, "uint8");
initSporeY1 = cast(c/2, "uint8")-15;
disp(cast(c/3, "uint8"))
initSporeX2 = cast(r/2, "uint8");
initSporeY2 = cast(c/2, "uint8")+15;
...
% amount of times the cells will be updated, less iterations than other 
% simulations because the main focus is the figure 8 which occurs quite
